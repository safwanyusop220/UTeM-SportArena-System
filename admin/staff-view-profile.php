                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h2 class="page-title text-center" style="font-size:40px; font-family:'Roboto'"><b>Staff Profile</b></h2>
                                </div>
                                <div class="row justify-content-center">
                                <div class="col-xl-4">

                                <div class="card text-center m-auto">
                                <a type="button" class="btn btn-primary btn-sm m-2" href="staff-status-list.php"  style="width:80px; height:30px;">Back</a>
                                    <div class="card-body">
                                        <img src="../img/user-icon.jpeg" class="rounded-circle avatar-lg img-thumbnail"
                                        alt="profile-image">

                                        <h4 class="mb-0 mt-2"><?= $staffName?></h4>
                                        ...
                                        <div class="text-start mt-3">
                                            <p class=" mb-2 font-13"><strong>Email :</strong> <span class="ms-2"><?= $staffEmail?></span></p>

                                            <p class="mb-2 font-13"><strong>Staff ID :</strong><span class="ms-2"><?= $staffId?></span></p>

                                            <p class="mb-1 font-13"><strong>Phone No. :</strong> <span class="ms-2"><?= $staffNum?></span></p>
