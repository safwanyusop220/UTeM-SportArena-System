...
<head>
        <meta charset="utf-8" />
        <title>Staff Status List | UTeM SportArena</title>
                                                        ...
                                                        <table id="scroll-vertical-datatable" class="table dt-responsive nowrap w-100">
                                                            ...
                                                            <?php
                                                                ...
                                                                if(isset($_POST["filterList"])){
                                                                    ...
                                                                    $sql = "SELECT * FROM staff_request WHERE `status`='$filter' ORDER BY id";
                                                                }else{
                                                                        $sql = "SELECT * FROM staff_request WHERE `status`='Pending' ORDER BY id";
                                                                    }
                                                            ...
                                                            <input type="hidden" value="<?=$id?>" name="id">
                                                                ...
                                                                <td style="width: 170px; font-size:13px; text-align:center;"><?=$staffNum?></td>
                                                                <td style="width: 170px; font-size:13px; text-align:center;"><?=$status?></td>
                                                                <td style="width: 170px; font-size:13px; text-align:center;">
                                                                    <a href="staff-view-profile.php?id=<?= $id ?>" class="btn btn-info btn-sm"><i class="mdi mdi-text-box-search mdi-18px"></i> View</a>
