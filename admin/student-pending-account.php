        ...
        <div class="wrapper">
            ...
            <div class="leftside-menu" style="background-color: #6777ef;  color: black;">
                ...
                <ul class="side-nav" style="background-color: #6777ef;  color: black;">
                    ...
                    <li class="side-nav-title side-nav-item" style=" color: black;">SYSTEM</li>
                    ...
                    <li class="side-nav-item" style=" color: black;">
                        ...
                        <div class="collapse" id="sidebarStudent">
                            <ul class="side-nav-second-level">
                                ...
                                <li>
                                    <a href="student-status-list.php" style=" color: black;">Student Status List</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                                                        ...
                                                        <table id="scroll-vertical-datatable" class="table dt-responsive nowrap w-100">
                                                            ...
                                                            <input type="hidden" value="<?=$id?>" name="id">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="account-approval-student.php?action=decline&id=<?= $id ?>" class="btn btn-danger btn-sm" onClick="return confirm('Are You Sure Want to Reject this request?')"><i class="mdi mdi-book-remove-multiple-outline mdi-18px"></i> Decline</a>
