...
<head>
        <meta charset="utf-8" />
        <title>Staff Pending Acc | UTeM SportArena</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="header-title">All Pending Staff Account</h4>
                                                    ...
                                                    <div class="tab-pane show active" id="scroll-vertical-preview alt-pagination-preview">
                                                        <table id="scroll-vertical-datatable" class="table dt-responsive nowrap w-100">
                                                            <thead style="background-color:#1d2832; color:white;">
                                                                ...
                                                                <th style="width: 100px; font-size:13px; text-align:center;">Staff Number</th>
                                                                <th style="width: 140px; font-size:13px; text-align:center;">Account Status</th>
                                                                <th style="width: 100px; font-size:13px; text-align:center;">Role</th>
                                                                <th style="width: 225px; font-size:13px; text-align:center;">Action</th>
                                                                </tr>
                                                            </thead>   
                                                            <?php
                                                                //Query
                                                                $sql = "SELECT * FROM staff_request WHERE `status`='Pending'";
                                                            ...
                                                            <input type="hidden" value="<?=$id?>" name="id">
                                                                ...
                                                                <td style="width: 170px; font-size:13px; text-align:center;"><?=$staffName?> <small class="text-muted">(<?=$staffId?>)</small></td>
                                                                <td style="width: 170px; font-size:13px; text-align:center;"><?=$staffEmail?></td>
                                                                <td style="width: 100px; font-size:13px; text-align:center;"><?=$staffNum?></td>
                                                                ...
                                                                <td style="width: 100px; font-size:13px; text-align:center;"><?=$role?></td>
                                                                <td style="text-align:center;">
                                                                    <a href="account-approval-staff.php?action=approve&id=<?= $id ?>" class="btn btn-success btn-sm"><i class="mdi mdi-calendar-multiple-check mdi-18px" style="color: white; icon-large"></i> Approve</a>
                                                                    <a href="account-approval-staff.php?action=decline&id=<?= $id ?>" class="btn btn-danger btn-sm" onClick="return confirm('Are You Sure Want to Reject this request?')"><i class="mdi mdi-book-remove-multiple-outline mdi-18px"></i> Decline</a>
