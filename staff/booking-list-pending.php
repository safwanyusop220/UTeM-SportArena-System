...
<head>
        <meta charset="utf-8" />
        <title>Booking Pending | UTeM SportArena</title>
                                ...
                                <h6 class="page-title-right">
                                        <nav aria-label="breadcrumb text-end " style="font-size: 17px;">
                                            <ol class="breadcrumb bg-light-lighten p-2 mb-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="#"><i></i> Booking Management</a></li>
                                                <li class="breadcrumb-item active" aria-current="student-booking-history.php">Pending Booking List</li>
                                            </ol>
                                        </nav>
                                                    ...
                                                    <div class="tab-pane show active" id="scroll-vertical-preview alt-pagination-preview">
                                                        <table id="scroll-vertical-datatable" class="table dt-responsive nowrap w-100">
                                                            ...
                                                            <input type="hidden" value="<?=$id?>" name="id">
                                                                ...
                                                                <h5><span class="badge badge-warning-lighten"><i class="mdi mdi-timer-sand"></i><?=$status?></span></h5>
                                                                <td>
                                                                    <a href="booking-approval.php?action=approve&id=<?= $id ?>" class="btn btn-success btn-sm"><i class="mdi mdi-calendar-multiple-check mdi-18px" style="color: white; icon-large"></i> Approve</a>
                                                                    <a href="booking-approval.php?action=decline&id=<?= $id ?>" class="btn btn-danger btn-sm" onClick="return confirm('Are You Sure Want to Reject this request?')"><i class="mdi mdi-book-remove-multiple-outline mdi-18px"></i> Reject</a>
<!-- 
