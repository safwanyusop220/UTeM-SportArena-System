...
<head>
        <meta charset="utf-8" />
        <title>Approved List | UTeM SportArena</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="header-title">All Approve Booking</h4>
                                                    ...
                                                    <div class="tab-pane show active" id="scroll-vertical-preview alt-pagination-preview">
                                                        <table id="scroll-vertical-datatable" class="table dt-responsive nowrap w-100">
                                                            ...
                                                            <input type="hidden" value="<?=$id?>" name="id" style="text-align:center;">
                                                                ...
                                                                <!-- <td style="font-size:13px;"><h5><span class="badge badge-info-lighten"><i class="mdi mdi-cash"></i> <?=$status?></span></h5></td> -->
                                                                <td style="font-size:13px; text-align:center;"><h5><span class="badge badge-success-lighten"><i class="mdi mdi-bitcoin"></i> <?=$status?></span></h5></td>
                                                                <td style="font-size:13px; text-align:center;">
                                                                <a href="booking-view-approved.php?id=<?= $id ?>" class="btn btn-info btn-sm " ><i class="mdi mdi-text-box-search mdi-18px" style="text-align:center;"></i> View</a>
<!--
