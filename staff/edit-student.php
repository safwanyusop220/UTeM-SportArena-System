...
$userLogin = $_SESSION['userUniqeName'];
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $userMatricNum  = trim( $_POST["studMatric"]);
        $studEmail      = trim( $_POST["studEmail"]);
        $studNum        = trim( $_POST["studNum"]);


        //Query
        $sql = "UPDATE student SET studName=?, studMatric=?, studEmail=?, studNum=? WHERE id=?" ;
        $stmt = mysqli_prepare($conn, $sql);

        //Bind 
        mysqli_stmt_bind_param($stmt, "ssssi", $studName,  $userMatricNum, $studEmail, $studNum, $id );
        //execute
        if (mysqli_stmt_execute ($stmt)){
            echo "<script>alert('Successfully update data');window.location.href='staff-registered-student.php'</script>";
        }
        else {
            echo "<script>alert('Sorry, your databse problem ');window.location.href='staff-registered-student.php'</script>";
        }
    }
                        ...
                        <div class="col-12">
                            ...
                            <div class="col-8 mx-auto">
                                <div class="card mt-3">
                                    ...
                                    <div class="card-header-actions"> <a href="staff-registered-student.php" class="card-header-action btn btn-success btn-sm m-2 mdi mdi-arrow-left-bold-outline " style="color: white; icon-large">Back</a></div>
                                    ...
                                    <div class="row g-2">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="studName" name="studName" value="<?= $studName?>" >
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label for="studMatric" class="form-label">Student Matric Number</label>
                                            <input type="text" class="form-control" id="studMatric" name="studMatric"  value="<?= $userMatricNum?>" >
                                        </div>
                                    </div>

                                    <div class="row g-2">
                                        <div class="mb-3 col-md-6">
                                            <label for="studEmail" class="form-label">Student Email</label>
                                            <input type="text" class="form-control" id="studEmail" name="studEmail" value="<?= $studEmail?>" >
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label for="studNum" class="form-label">Student Number</label>
                                            <input type="text" class="form-control" id="studNum" name="studNum"  value="<?= $studNum?>" >
                                        </div>
                                    </div>
