                    ...
                    <div class="navbar-custom" style="background-color: #6777ef;">
                        <ul class="list-unstyled topbar-menu float-end mb-0">
                            ...
                            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                                    ...
                                    <span>
                                        <span class="account-user-name" style="color:blue; font:ultra;"><?= $userLogin?></span>
                                        <span class="account-position">Staff Access</span>
                                    </span>
                                </a>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="header-title">All Booking</h4>
                                                    ...
                                                    <div class="tab-pane show active" id="scroll-vertical-preview alt-pagination-preview">
                                                        <table id="scroll-vertical-datatable" class="table dt-responsive nowrap w-100">
                                                            ...
                                                            <input type="hidden" value="<?=$id?>" name="id">
                                                                ...
                                                                <!-- <td style="font-size:13px;"><h5><span class="badge "></span></h5></td> -->
                                                                <td>
                                                                    ...
                                                                    <a href="booking-approval.php?action=decline&id=<?= $id ?>" class="btn btn-danger btn-sm" onClick="return confirm('Are You Sure Want to Reject this request?')"><i class="mdi mdi-book-remove-multiple-outline mdi-18px"></i> Decline</a>
<!-- 
