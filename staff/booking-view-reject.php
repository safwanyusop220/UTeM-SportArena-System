                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 mx-auto">
                                <div class="card mt-3">
                                    ...
                                    <div class="card-header-actions"> <a href="booking-list-reject.php" class="card-header-action btn btn-success btn-sm m-2 mdi mdi-arrow-left-bold-outline " style="color: white; icon-large">Back</a></div>
                        ...
                        <table class="table table-hover" >
                            ...
                            <tr>
                                ...
                                <!-- <td><img src="<?=$sportImage ?>" class="card-img float-sm-left" style="width: 300px;" alt="SportImage"></td> -->
                            </tr>
                        ...
                        <?php      
                                ...
                                // If error
                                echo "<script>alert('Sorry, there are no data exist');window.location.href='booking-list-pending.php'</script>";
