...
include "../sql/secureStaff.php";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if (mysqli_stmt_execute ($stmt)){
            echo "<script>alert('Successfully update the booking date');window.location.href='staff-booking-list.php'</script>";
        }
        else {
            echo "<script>alert('Sorry, your databse problem ');window.location.href='staff-booking-list.php'</script>";
        }
    }
                        ...
                        <div class="col-12">
                            ...
                            <div class="col-8 mx-auto">
                                <div class="card mt-3">
                                    ...
                                    <div class="card-header-actions"> <a href="staff-booking-list.php" class="card-header-action btn btn-success btn-sm m-2 mdi mdi-arrow-left-bold-outline " style="color: white; icon-large">Back</a></div>
