...
<head>
    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
        ...
        <div class="wrapper">
            <!-- ========== Left Sidebar Start ========== -->
            <div class="leftside-menu" style="background-color: white;">
                ...
                <!--- Sidemenu -->
                <ul class="side-nav" style="background-color: white;">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarDashboards">
                            <ul class="side-nav-second-level">
                                <!-- <li>
                                    <a href="student-facility-list.php">Dashboard</a>
                                </li> -->
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarManage">
                            <ul class="side-nav-second-level">
                                ...
                                <li>
                                    <a href="student-booking-pending.php">Student Management</a>
                                </li>
                            </ul>
                        </div>
                    </li>

                    <li class="side-nav-title side-nav-item">LOGS</li>
                    ...
                    <!-- Help Box -->
                    <div class="help-box text-black text-center" style="background-color: grey;">
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="card mt-4 col-11 p-1">
