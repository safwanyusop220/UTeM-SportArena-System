                        ...
                        <div class="row">
                            ...
                            <div class="col-8 mx-auto">
                                <div class="card mt-3">
                                    ...
                                    <div class="card-header-actions"> <a href="student-booking-history.php" class="card-header-action btn btn-success btn-sm m-2 mdi mdi-arrow-left-bold-outline " style="color: white; icon-large">Back</a></div>
                        ...
                        <table class="table table-hover" >
                            ...
                            <?php
                                ...
                                if ($resultCheck > 0){
                                    ...
                                    // If error
                                    echo "<script>alert('Sorry, there are no data exist');window.location.href='student-booking-history.php'</script>";
