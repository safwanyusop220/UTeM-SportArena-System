                        ...
                        <table class="table table-hover" >
                            ...
                            <?php
                                ...
                                if ($resultCheck > 0){
                                    ...
                                    // If error
                                    echo "<script>alert('Sorry, there are no data exist');window.location.href='student-booking-list.php'</script>";
...
<!-- 
                            <tr>
                                ...
                                <td style="padding:15px 105px;"><span class="badge badge-success">Active</span></td>
                            </tr> -->
                        </tbody>
                        <?php      
                                }          
