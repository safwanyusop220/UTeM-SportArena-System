...
<head>
    <meta charset="utf-8" />
    <title>Pending Booking | UTeM SportArena</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h2 class="page-title text-center" style="color: #1A1925; font-size: 30px; font-family:'Roboto'">Pending Booking for  <?=$userLogin?></h2>
                            <h6 class="page-title-right">
                                        <nav aria-label="breadcrumb text-end " style="font-size: 17px;">
                                            <ol class="breadcrumb bg-light-lighten p-2 mb-0">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="student-booking-pending.php">Pending Booking</li>
                                            </ol>
                                        </nav>

                                    </h6>
                                <!-- <center>
                                    <h2 class="page-title">Booking List For <?=$userLogin?></h2>
                                </center> -->
                            </div>
                        </div>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="width: 300px; text-align: center;"> 
                                                                    <a href="booking-view-pending.php?id=<?= $id ?>" class="btn btn-info btn-sm"><i class="mdi mdi-text-box-search mdi-18px"></i> View</a>
                                                                    <!-- <a href="booking-edit.php?id=<?= $id ?>" class="btn btn-primary btn-sm"><i class="mdi mdi-clipboard-edit-outline mdi-18px" style="color: white; icon-large"></i> Edit</a> -->
                                                                    <a href="booking-delete.php?delete=<?= $id ?>" class="btn btn-danger btn-sm" onClick="return confirm('Are You Sure Want to delete?')"><i class="mdi mdi-book-remove-multiple-outline mdi-18px"></i> Cancel</a>
