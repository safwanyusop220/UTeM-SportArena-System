...
<head>
        <meta charset="utf-8" />
        <title>Logout | UTeM SportArena</title>
    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
                    ...
                    <div class="col-xxl-4 col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-header pt-4 pb-4 text-center bg-success">
                                <a href="index.html">
                                    <span><img src="../images/logo_utem.png" alt="" width="250" height="64"></span>
                                </a>
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Back to <a href="../index.html" class="text-muted ms-1" ><b class="text-success">Log In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
        ...
        <footer class="footer footer-alt">
             Developed by Safwan Yusop || 2022 © PSM1-UTeM
        </footer>
